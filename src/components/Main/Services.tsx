    ...
    const services = [
        {
            ...
            description: "Full-stack web applications using modern technologies like React, Node.js, Java, Go and Python frameworks.",
            color: "primary"
        },
        {
            icon: "bi-phone",
                    ...
                    <div className="col-lg-8 col-xl-6">
                        <div className="text-center">
                            <h2 className="fw-bolder mb-5">
                                <span className="d-inline">What I Do</span>
                            </h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col mb-5 h-100" key={index}>
                            <div className="card h-100 shadow border-0">
                                <div className="card-body p-4">
                                    <div className={`feature bg-${service.color} bg-gradiant text-white rounded-3 mb-3`}>
                                        <i className={`bi ${service.icon}`}></i>
                                    </div>
                                    <h5 className="fw-bolder">
                                        <span className="text-gradnt d-inline">{service.title}</span>
                                    </h5>
